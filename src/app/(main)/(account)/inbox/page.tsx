...
export default function InboxPage() {
    return (
        <div className="p-6 md:p-10 lg:p-16 h-full flex flex-col items-center justify-center text-center">
            ...
            <h1 className="text-3xl font-black text-[var(--color-on-surface)] tracking-tight mb-2">Inbox</h1>
            <p className="text-[var(--color-on-surface-variant)] opacity-60 max-w-md">
                Check your notifications, messages, and important alerts across businesses.
            </p>
        </div>
    );
}
