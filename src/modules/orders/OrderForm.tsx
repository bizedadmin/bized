...
export function OrderForm({ initialData, isEditing = false }: OrderFormProps) {
    ...
    const [formData, setFormData] = useState({
        ...
        shippingAddress: initialData?.orderDelivery?.address ? {
            street: initialData.orderDelivery.address.streetAddress,
            city: initialData.orderDelivery.address.addressLocality,
            state: initialData.orderDelivery.address.addressRegion,
            zip: initialData.orderDelivery.address.postalCode,
            country: initialData.orderDelivery.address.addressCountry,
        } : ({
            street: "",
            city: "",
            state: "",
        ...
        items: initialData?.orderedItem || [
            { name: "", quantity: 1, price: 0, total: 0 }
        ],
        tax: initialData?.tax || 0,
        discount: initialData?.discount || 0,
        currency: initialData?.priceCurrency || "KES",
        status: initialData?.orderStatus || "OrderPending",
    ...
    const calculateTotals = (items: OrderItem[], tax: number, discount: number) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const payload = {
            ...
            orderDelivery: {
                address: {
                    streetAddress: formData.shippingAddress.street,
                    addressLocality: formData.shippingAddress.city,
                    addressRegion: formData.shippingAddress.state,
                    postalCode: formData.shippingAddress.zip,
                    addressCountry: formData.shippingAddress.country,
                }
            }
        }

        try {
            const url = isEditing ? `/api/business/orders/${initialData._id}` : '/api/business/orders'
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <Card>
                        ...
                        <CardContent className="p-0">
                            <Table>
                                <TableHeader>
                                    <TableRow>
                                        <TableHead className="w-[40%] font-bold">Item</TableHead>
                                        ...
                                        <TableRow key={index} className="group">
                                            ...
                                            <TableCell>
                                                <div className="relative">
                                                    ...
                                                    <Input
                                                        type="number"
                                                        className="pl-12 w-32 text-right"
                                                        value={item.price}
                ...
                <div className="space-y-8">
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            <div className="space-y-2">
                                <Label htmlFor="status">Fullfillment Status</Label>
                                <Select
                                ...
                                >
                                    ...
                                    <SelectContent>
                                        <SelectItem value="OrderPending">Pending</SelectItem>
                                        <SelectItem value="OrderProcessing">Processing</SelectItem>
                                        <SelectItem value="OrderInTransit">Shipped</SelectItem>
                    ...
                    <Card className="bg-muted/30">
                        ...
                        <CardContent className="space-y-4">
                            <div className="flex justify-between text-sm">
                                ...
                                <span className="font-bold">{formData.currency} {subtotal.toLocaleString()}</span>
                            </div>
